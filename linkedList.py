...
List[3] = 95
List.fromList([3,5,6,3,6])
List2 = LinkedList()
print(List)
print(List.isEmpty())

print(List.contains(10000))
print(type(List.toList()))
print(type(List))
List.docs()
List2.fromList([2,6,4,4,4])
List.merge(List2)
print(List)
List.map(lambda x:x*x)
print(List)
indices = List.indexOfAll(1000)
print(indices)
modifiedList = List.filteredList(lambda x:x%2==0)
print("-------------------")
print(modifiedList)
print("-------------------")
print(List.min())
print("--------------")
reduced = List.reduceList(lambda acc, x: acc + x,0)
print(List.max())
print(List)
List.reverse()
print(List)
print(List.insertBefore(36,22))
print(List)
cloned_list = List.clone()
print
print(cloned_list)
List.insertAfter(36,10000)
